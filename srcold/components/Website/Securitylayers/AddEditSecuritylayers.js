...
const AddEditSecuritylayers = () => {
    ...
    const { FetchSecuritylayers_API, CRUDSecurityGroup_API, FetchAllSecuritylayers_API, DeleteSecurityGroup_API } = API();
                                                            ...
                                                            <div className={' row p-0 w-100  mb-3 m-auto '}>
                                                                {payloadobj.permissionsarr.map((subitem, subitemindex) => {
                                                                    if (subitem.structype == 'Child' && subitem.ref_parent_id == mainitem.id) {
                                                                        return (
                                                                            <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 mt-lg-2 m-0 mb-0 p-sm-0">
