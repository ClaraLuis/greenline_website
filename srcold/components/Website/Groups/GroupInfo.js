            ...
            <Modal.Body>
                <div class="row m-0 w-100 py-2 allcentered">
                    <Form
                        ...
                        payload={props?.grouppayload}
                        setpayload={props?.setgrouppayload}
                        button1disabled={GroupMutation.isLoading}
                        button1class={generalstyles.roundbutton + ' bg-info bg-infohover mr-2 '}
                        button1placeholder={props?.grouppayload?.functype == 'add' ? lang.add : lang.edit}
                        button1onClick={() => {
                            GroupMutation.mutate(props?.grouppayload);
                        }}
                        button2={props?.grouppayload?.functype == 'add' ? false : true}
                        button2disabled={DeleteGroupMutation.isLoading}
