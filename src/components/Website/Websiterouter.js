                        ...
                        <div class={generalstyles.app_container + ' w-100 '}>
                            <div class="row m-0 w-100">
                                <div class={`${generalstyles.app_main}` + '  app_main  '}>
                                                                    ...
                                                                    <div class="row m-0 w-100">
                                                                        <div class="col-lg-7 p-0">
                                                                            <span style={{ fontWeight: 600 }}>
                                                                                All Notifications
                                                                                <span
                                                                                    style={{ fontWeight: 400, color: 'white', background: '#fcb636', borderRadius: '12px', fontSize: '10px' }}
                                    ...
                                    <div
                                        class={
                                            pagetitle_context == 'dashboard' && !hidesidenav_context ? generalstyles.app_container_inner + ' w-100 pt-0 ' : generalstyles.app_container_inner + ' p-1 '
                                        }
                                    >
                                        <Route
