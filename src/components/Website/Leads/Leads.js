    ...
    return (
        <div class="row m-0 w-100 p-md-2 pt-2">
            <div class="row m-0 w-100 d-flex align-items-center justify-content-start mt-sm-2 pb-5 pb-md-0">
                ...
                {FetchLeads?.isSuccess && !FetchLeads?.isFetching && (
                    <div class="col-lg-12 p-0 mt-2">
                        <div className="row m-0 w-100">
                            ...
                            {FetchLeads?.data?.data?.phases?.map((item, index) => {
                                return (
                                    <div
                                        onClick={() => {
                                    ...
                                    >
                                        <span class="text-info">{item?.totalleads}</span> {item?.name}
                                    </div>
                                );
                            })}
                        </div>
                ...
                <div style={{ zIndex: 10000 }} class={generalstyles.card + ' row m-0 p-2 w-100'}>
                ...
                <div class={generalstyles.card + ' row m-0 w-100'}>
                    ...
                    <div class={' col-lg-6 col-md-6 col-sm-6 p-0 pr-3 pr-md-1 pr-sm-0 d-flex align-items-center justify-content-end pb-1 '}>
                        ...
                        <div>
                            <button
                                className={`${generalstyles.checkbox} ${checkboxstyles.checkbox} ` + ' d-flex mb-0 '}
                                onClick={() => {
                                    ...
                                    axios({
                                        url: serverbaselink + '/api/leads/exportleads', //your url
                                        method: 'GET',
                                        responseType: 'blob',
                                        params: { filter: filterLeadscontext },
                            ...
                            >
                                {isexportloading && <CircularProgress color="green" width="20px" height="20px" duration="1s" />}
                                <p className={`` + ' mr-4 ml-3 mb-0 cursor-pointer text-capitalize wordbreak '} style={{ fontSize: '13px', color: 'green' }}>
                                    Export
                                </p>
                            </button>
                        </div>
